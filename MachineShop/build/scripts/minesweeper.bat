...
set CLASSPATH=%APP_HOME%\lib\minesweeper-1.0.jar

@rem Execute minesweeper
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MINESWEEPER_OPTS%  -classpath "%CLASSPATH%" edu.jsu.mcis.Main %CMD_LINE_ARGS%
